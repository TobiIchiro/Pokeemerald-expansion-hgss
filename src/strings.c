...
const u8 gText_PkmnMemo[] = _("POKéMON MEMO");
...
const u8 gText_DexNum_Info[] = _("Dex No.");
const u8 gText_Name_Info[] = _("Name");
const u8 gText_Type_Info[] = _("Type");
const u8 gText_Tera_Info[] = _("Tera");
const u8 gText_OT_Info[] = _("OT");
const u8 gText_IDNumber_Info[] = _("ID No.");
const u8 gText_Nothing_Memo[] = _("Happily eats anything.");
const u8 gText_Flavor_Memo[] = _("Likes {COLOR LIGHT_RED}{SHADOW GREEN}{DYNAMIC 8}{COLOR WHITE}{SHADOW DARK_GRAY} food.");
const u8 gText_Spicy_Memo[] = _("Likes {COLOR LIGHT_RED}{SHADOW GREEN}Spicy{COLOR WHITE}{SHADOW DARK_GRAY} food.");
const u8 gText_Dry_Memo[] = _("Likes {COLOR LIGHT_RED}{SHADOW GREEN}Dry{COLOR WHITE}{SHADOW DARK_GRAY} food.");
const u8 gText_Sweet_Memo[] = _("Likes {COLOR LIGHT_RED}{SHADOW GREEN}Sweet{COLOR WHITE}{SHADOW DARK_GRAY} food.");
const u8 gText_Bitter_Memo[] = _("Likes {COLOR LIGHT_RED}{SHADOW GREEN}Bitter{COLOR WHITE}{SHADOW DARK_GRAY} food.");
const u8 gText_Sour_Memo[] = _("Likes {COLOR LIGHT_RED}{SHADOW GREEN}Sour{COLOR WHITE}{SHADOW DARK_GRAY} food.");
const u8 gText_HP_Skills[] = _("HP");
const u8 gText_Attack_Skills[] = _("Attack");
const u8 gText_Defense_Skills[] = _("Defense");
